                ...
                <tbody>
                    ...
                    @foreach($carts as $cart)
                        ...
                        @if ($cart->product->galleries)
                            <img src="{{ Storage::url($cart->product->galleries->first()->photos) }}" class="cart-image" alt="" class="w-100" />
                        @endif
                        </td>
                        <td style="width: 35%">
          ...
          <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-md-6">
              <div class="from-group mb-3">
                ...
                <input type="text" class="form-control" id="address_one" name="address_one" value="Cicukang" />
              </div>
            </div>
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="address_two" class="form-label">Address 2</label>
                <input type="text" class="form-control" id="address_two" name="address_two" value="No 190" />
              </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="zip_code" name="zip_code" value="40294" />
              </div>
            </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone_number" name="phone_number" value="+62 2020 11111" />
              </div>
            </div>
          </div>
          <div class="row" data-aos="fade-up" data-aos-delay="150">
